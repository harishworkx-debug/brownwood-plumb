...
const area = serviceAreas.find(a => a.slug === "comanche-tx")!;
const content = areaContent["comanche-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-comanche-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-comanche-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-comanche-tx` }],
    };
  },
