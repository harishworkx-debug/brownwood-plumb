...
const area = serviceAreas.find(a => a.slug === "early-tx")!;
const content = areaContent["early-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-early-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-early-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-early-tx` }],
    };
  },
