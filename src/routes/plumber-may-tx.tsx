...
const area = serviceAreas.find(a => a.slug === "may-tx")!;
const content = areaContent["may-tx"] || defaultContent;
  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-may-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-may-tx` }],
    };
  },
