...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Connecting Brownwood to trusted plumbers for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair, drain cleaning, and residential services. Call (325) 728-4690." },
      ...
      { property: "og:description", content: "Brownwood's trusted plumber for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair, drain cleaning. Call (325) 728-4690." },
      ...
      { name: "twitter:description", content: "Brownwood's trusted plumber for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair. Call (325) 728-4690." },
