...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional local Brownwood plumbing company for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair, and drain cleaning. Call (325) 728-4690." },
      { name: "keywords", content: "plumber brownwood tx, emergency plumber brownwood, 24 hour plumber, residential plumber, water heater repair brownwood, drain cleaning brownwood tx, leak detection brownwood" },
      ...
      { property: "og:description", content: "Professional local Brownwood plumbing company for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair, and drain cleaning. Call (325) 728-4690." },
      ...
      { name: "twitter:title", content: "Plumber in Brownwood, TX | M. Webb Plumbing Co." },
      { name: "twitter:description", content: "Professional local Brownwood plumbing company for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair. Call (325) 728-4690." },
