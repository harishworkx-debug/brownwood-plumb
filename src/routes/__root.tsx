...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trusted residential & commercial plumber in Brownwood, TX. 24-hour emergency plumbing, leak detection, water line repair & more. Call +13253280435." },
      ...
      { property: "og:description", content: "Trusted residential & commercial plumber in Brownwood, TX. 24-hour emergency plumbing, leak detection, water line repair & more. Call +13253280435." },
      ...
      { name: "twitter:description", content: "Trusted residential & commercial plumber in Brownwood, TX. 24-hour emergency plumbing, leak detection, water line repair & more. Call +13253280435." },
