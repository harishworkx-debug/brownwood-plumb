...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional local Brownwood plumbing company for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair, and drain cleaning. Call (855) 321-3189." },
      ...
      { property: "og:description", content: "Professional local Brownwood plumbing company for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair, and drain cleaning. Call (855) 321-3189." },
      ...
      { name: "twitter:description", content: "Professional local Brownwood plumbing company for 35+ years. 24-hour emergency plumbing, leak detection, water heater repair. Call (855) 321-3189." },
