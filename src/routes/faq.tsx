...
const additionalFaqs = [
  ...
  },
  {
    ...
    answer: "First, shut off the main water valve to your home (usually located near the street or in a utility area). This stops water flow and limits damage. Turn off your water heater to prevent damage. Move valuables away from water. Then call us at (855) 321-3189 — we have a 24-hour emergency line.",
    category: "Emergency",
  },
  {
...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Answers to common plumbing questions about emergency service, pricing, warranties, service areas, and more. Serving Brownwood, TX and Brown County. Call (855) 321-3189." },
