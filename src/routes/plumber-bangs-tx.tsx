...
const area = serviceAreas.find(a => a.slug === "bangs-tx")!;
const content = areaContent["bangs-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-bangs-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-bangs-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-bangs-tx` }],
    };
  },
