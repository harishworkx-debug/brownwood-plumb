        ...
        <Reveal delay={300}>
          <div className="mt-12 rounded-2xl border border-border bg-card p-8 shadow-sm">
            ...
            <p className="mt-2 text-foreground/70">
              We serve communities throughout Brown County and Central Texas. If you don't see your location listed, give us a call at <a href="tel:+13256412662" className="font-semibold text-brand-deep hover:underline">(325) 728-4690</a> — we're likely able to help.
            </p>
          </div>
        </Reveal>
      </Section>
