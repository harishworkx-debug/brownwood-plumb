...
export const Route = createFileRoute("/service-areas")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "M. Webb Plumbing serves Brownwood, Early, Bangs, Lake Brownwood, Zephyr, Blanket, May, Brookesmith, Comanche, Coleman and surrounding Central Texas communities. 24-hour emergency plumbing. Call (855) 321-3189." },
        ...
        <Reveal delay={300}>
          <div className="mt-12 rounded-2xl border border-border bg-card p-8 shadow-sm">
            ...
            <p className="mt-2 text-foreground/70">
              We serve communities throughout Brown County and Central Texas. If you don't see your location listed, give us a call at <a href="tel:+18553213189" className="font-semibold text-brand-deep hover:underline">(855) 321-3189</a> — we're likely able to help.
            </p>
          </div>
        </Reveal>
      </Section>
