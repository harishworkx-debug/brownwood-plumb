...
const area = serviceAreas.find(a => a.slug === "brookesmith-tx")!;
const content = areaContent["brookesmith-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-brookesmith-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-brookesmith-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-brookesmith-tx` }],
    };
  },
