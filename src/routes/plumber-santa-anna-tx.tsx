...
const area = serviceAreas.find(a => a.slug === "santa-anna-tx")!;
const content = areaContent["santa-anna-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-santa-anna-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-santa-anna-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-santa-anna-tx` }],
    };
  },
