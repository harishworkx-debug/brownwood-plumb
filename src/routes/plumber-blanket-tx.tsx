...
const area = serviceAreas.find(a => a.slug === "blanket-tx")!;
const content = areaContent["blanket-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-blanket-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-blanket-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-blanket-tx` }],
    };
  },
