...
const area = serviceAreas.find(a => a.slug === "coleman-tx")!;
const content = areaContent["coleman-tx"] || defaultContent;

export const Route = createFileRoute("/plumber-coleman-tx")({
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-coleman-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-coleman-tx` }],
    };
  },
