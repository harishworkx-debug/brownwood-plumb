...
const area = serviceAreas.find(a => a.slug === "brownwood-tx")!;
const content = areaContent["brownwood-tx"] || defaultContent;
  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-brownwood-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-brownwood-tx` }],
    };
  },
