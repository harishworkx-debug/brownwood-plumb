...
export const Route = createFileRoute("/financing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Flexible financing options for plumbing services in Brownwood, TX. Get the repairs you need now with affordable monthly payments. Call (855) 321-3189 to discuss options." },
