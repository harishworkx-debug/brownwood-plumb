...
const area = serviceAreas.find(a => a.slug === "rising-star-tx")!;
const content = areaContent["rising-star-tx"] || defaultContent;
  ...
  head: () => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `${BASE_URL}/plumber-rising-star-tx` },
        { property: "og:type", content: "website" },
      ],
      links: [{ rel: "canonical", href: `${BASE_URL}/plumber-rising-star-tx` }],
    };
  },
